        ...
        <div>
            ...
            <section className="py-24 relative">
                <div className="w-full max-w-7xl px-4 md:px-5 lg:px-5 mx-auto">
                    ...
                    {/* <div className="w-full justify-start items-center gap-12 grid lg:grid-cols-2 grid-cols-1 py-16">
                        ...
                        <div
                            ...
                            <div className="pt-24 lg:justify-center sm:justify-end justify-start items-start gap-2.5 flex">
                                <img className=" rounded-xl object-cover" src="/bg/Reels Market/rm-1.jpg" alt="about Us image" />
                            </div>
                            <img className="sm:ml-0 ml-auto rounded-xl object-cover" src="/bg/Reels Market/rm-2.jpg"
                                alt="about Us image" />
                        </div>
                    </div> */}
                    <div className="w-full justify-start items-center gap-12 grid lg:grid-cols-2 grid-cols-1 py-12">
                        {/* Content on left */}
                        <div className="w-full flex-col justify-center lg:items-start items-center gap-10 inline-flex lg:order-first order-last">
                            <div className="w-full flex-col justify-center items-start gap-8 flex">
                                <div className="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                                    ...
                                    <p className="text-gray-500 text-base font-medium leading-relaxed text-justify">
                                        The <span className="font-semibold">"Reels Marketing"</span> is a modern digital strategy that uses short, creative videos to promote brands and engage audiences on platforms like Instagram, Facebook, and YouTube Shorts. It focuses on storytelling and visual appeal to boost visibility and connection. Participating in a reels marketing event helps students gain hands-on experience in digital promotion, creativity, and communication—key skills for today’s marketing professionals.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="w-full justify-start items-center gap-12 grid lg:grid-cols-2 grid-cols-1 py-10">
                        <div
